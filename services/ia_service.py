...
- IMAGENS ILUSTRATIVAS: Se o tema for favorecido por visualização do mundo real, adicione uma foto no meio da explicação usando `![Ilustração](https://image.pollinations.ai/prompt/SEU_PROMPT_EM_INGLES_AQUI)`. O seu prompt deve ser preciso, descritivo e incluir termos como "accurate educational illustration" para evitar imagens bizarras. Exemplo: `![Célula Animal](https://image.pollinations.ai/prompt/accurate-educational-illustration-of-animal-cell)`.
